pswimport java.io.ByteArrayOutputStream;
import java.io.File;
...
public class Insert {
	...
	/*
	 * Below method inserts new table 
	 * columns into davisbase_columns table
	 */
		...
		try {
        	...
        	if(space>=newrow_space) {     
	        	...
	        	if(no_of_pages==1) {	        		 
		        	 ...
		        	 TableFile.writeByte(row_count-div);Iw12dawtdat.tlpita
	...
	/*
	 * Below method cauluclates left space in the page
	 */
	...
	/*
	 * Below method calculates payload
	 * for a new row of a davisbase_tables table
	 */
